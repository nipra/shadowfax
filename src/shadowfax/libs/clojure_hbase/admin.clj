(ns shadowfax.libs.clojure-hbase.admin
  (:refer-clojure :rename {get map-get} :exclude [flush])
  (:use shadowfax.libs.clojure-hbase.core
        shadowfax.libs.clojure-hbase.internal)
...
(defn modify-column-family
  [table-name ^HColumnDescriptor column-descriptor]
  (.modifyColumn @*admin* (to-bytes table-name) column-descriptor))
