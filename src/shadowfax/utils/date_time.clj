...
(comment
  (ctc/to-time-zone (ctco/from-long 1404190800000) (ctc/time-zone-for-offset -5)))

(comment
  (range->days (ctf/parse (ctf/formatter "yyyy-MM-dd") "2013-04-17")
               (ctf/parse (ctf/formatter "yyyy-MM-dd") "2013-04-18")))
